...
exports.getCVbyId = async (req, res) => {
  ...
  const candidat_id = await req.params.candidat_id;
  console.log("candidat id is", candidat_id);

  cv.getCVbyId(candidat_id, (err, data) => {
    ...
    if (err) {
      ...
      console.log("data cv by id is", data.rows);
